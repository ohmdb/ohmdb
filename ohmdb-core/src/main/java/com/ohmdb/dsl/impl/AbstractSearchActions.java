...
public abstract class AbstractSearchActions<E> implements BoundableSearch<E> {
	...
	protected final TableInternals<E> tableInternals;
	protected final JokerCreator jokerator;

	@SuppressWarnings("unchecked")
	public AbstractSearchActions(Table<E> table) {
		this.tableInternals = (TableInternals<E>) table;
		this.jokerator = tableInternals.jokerator();
		this.table = table;
	}
	...
	public void each(Visitor<E> visitor) {
		tableInternals.forEach(findIDs(), visitor);
	}
