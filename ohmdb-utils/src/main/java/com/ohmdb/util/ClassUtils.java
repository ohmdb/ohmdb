...
public class ClassUtils {
	...
	public static Object getPropValue(Object instance, String propertyName) {
		String propertyNameCap = U.capitalize(propertyName);
		...
		try {
			...
			throw Errors.rte("Cannot get property value!", e);
		}

		throw Errors.rte("Cannot find the property '%s' in the class '%s'", propertyName, instance.getClass());
	}
